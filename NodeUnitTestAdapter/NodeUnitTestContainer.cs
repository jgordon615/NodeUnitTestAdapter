...
{
    public class NodeUnitTestContainer : ITestContainer
    {
        private ITestContainerDiscoverer discoverer;
        public NodeUnitTestContainer(ITestContainerDiscoverer discoverer, string source, Uri executorUri)
            : this(discoverer, source, executorUri, Enumerable.Empty<Guid>())
        { }

        public NodeUnitTestContainer(ITestContainerDiscoverer discoverer, string source, Uri executorUri, IEnumerable<Guid> debugEngines)
        {
            this.Source = source;
        ...
        private NodeUnitTestContainer(NodeUnitTestContainer copy)
        ...
        {
            var testContainer = other as NodeUnitTestContainer;
        ...
        {
            return new NodeUnitTestContainer(this);
        }
    }
